...
import { useBonusRecordQuery } from '@/apis/origin/transactionRecord/bonus';
...
export const BonusRecord = ({
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } = useBonusRecordQuery({
