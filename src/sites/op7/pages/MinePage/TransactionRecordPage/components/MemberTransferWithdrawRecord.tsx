...
import { useMemberTransferQuery } from '@/apis/origin/transactionRecord/memberTransferWithdraw';
...
interface MemberTransferWithdrawProps {
...
export const MemberTransferWithdraw = ({
  dateRange,
  setSimplePickerData,
  setTotalInfo,
  currentPickerType,
  onItemClick,
}: MemberTransferWithdrawProps) => {
            ...
            <div className="flex items-center gap-8px">
              <div className="flex flex-col items-end gap-4px">
                <p className="_tf[16] font-500 leading-[1.5] din-pro text-[var(--Text-Main-10)]">
                  {formatNumber(item.cash * (item.transferPerspective === 'IN' ? 1 : -1))}
                </p>
