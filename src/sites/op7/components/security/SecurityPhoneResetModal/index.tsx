...
const UNBIND_PHONE_TYPE = 7;

export interface SecurityPhoneResetModalProps {
  visible: boolean;
  onClose: () => void;
  /** 解绑成功后可回调刷新安全中心数据 */
  onSuccess?: () => void;
...
const SecurityPhoneResetModal: React.FC<SecurityPhoneResetModalProps> = ({
  visible,
  onClose,
  onSuccess,
  onRequireRebind,
  ...
  return (
    <SecurityVerifyModal
      ...
      title="手机解绑"
      tip="请选择一种动态验证进行解绑"
      microsoftStepPageTitle="手机解绑"
      microsoftVerifyType={UNBIND_PHONE_TYPE}
...
export default SecurityPhoneResetModal;
