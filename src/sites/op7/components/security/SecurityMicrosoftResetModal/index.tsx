...
const UNBIND_MICROSOFT_TYPE = 11;

export interface SecurityMicrosoftResetModalProps {
  visible: boolean;
  onClose: () => void;
  /** 解绑成功后可回调刷新安全中心数据 */
  onSuccess?: () => void;
...
const SecurityMicrosoftResetModal: React.FC<SecurityMicrosoftResetModalProps> = ({
  visible,
  onClose,
  onSuccess,
  onRequireRebind,
  ...
  return (
    <SecurityVerifyModal
      ...
      title="解绑微软安全令牌"
      tip="请选择一种动态验证进行解绑"
      microsoftStepPageTitle="解绑微软安全令牌"
      microsoftVerifyType={UNBIND_MICROSOFT_TYPE}
...
export default SecurityMicrosoftResetModal;
