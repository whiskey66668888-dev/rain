...
export const FOLLOW_MATCH_IDS_FB_KEY = 'FOLLOW_MATCH_IDS_FB';
export const FOLLOW_MATCH_IDS_EB_KEY = 'FOLLOW_MATCH_IDS_EB';
export const IS_SIMPLE_ODDS_KEY = 'IS_SIMPLE_ODDS';
export const IS_OPEN_GOAL_SOUND_KEY = 'IS_OPEN_GOAL_SOUND';
export const BETTING_ODDS_SETTINGS_KEY = 'BETTING_ODDS_SETTINGS';
export const HIDE_BET_DRAWER_APP_DOWNLOAD_KEY = 'HIDE_BET_DRAWER_APP_DOWNLOAD';
export const SPORT_VENUE_KEY = 'SPORT_VENUE';
